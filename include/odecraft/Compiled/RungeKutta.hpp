#ifndef ODECRAFT_COMPILED_RUNGEKUTTA_HPP
#define ODECRAFT_COMPILED_RUNGEKUTTA_HPP

/**
 * @file Compiled/RungeKutta.hpp
 * @brief Classic fixed-step RK4. Compiled by src/RungeKutta.cpp.
 *
...
#endif // ODECRAFT_COMPILED_RUNGEKUTTA_HPP
